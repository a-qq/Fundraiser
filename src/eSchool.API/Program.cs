...
using System.IO;
using System.Net;
using FundraisersManagement = FundraiserManagement.Infrastructure.Persistence;
using SchoolsManagement = SchoolManagement.Infrastructure.Persistence;
    ...
    public class Program
    {
        ...
        public static int Main(string[] args)
        {
            ...
            try
            {
                ...
                host.MigrateDbContext<SchoolsManagement.SchoolContext>((_, __) => { })
                    .MigrateDbContext<SchoolsManagement.IntegrationEventLogContext>((_, __) => { })
                    .MigrateDbContext<DeadLetterContext>((_, __) => { })
                    .MigrateDbContext<FundraisersManagement.FundraiserContext>((_, __) => { })
                    .MigrateDbContext<FundraisersManagement.IntegrationEventLogContext>((_, __) => { });
        ...
        private static Serilog.ILogger CreateSerilogLogger(IConfiguration configuration)
        {
            ...
            return new LoggerConfiguration()
                ...
                .Enrich.WithProperty("ApplicationContext", "eSchool")
