...
namespace SchoolManagement.Application.Schools.Commands.ChangeGroupAssignment
{
    ...
    internal sealed class
        ChangeGroupAssignmentHandler : IRequestHandler<ChangeGroupAssignmentCommand, Result<Unit, RequestError>>
    {
        ...
        public async Task<Result<Unit, RequestError>> Handle(ChangeGroupAssignmentCommand request,
