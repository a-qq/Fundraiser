...
{
    internal sealed class GraduationCompletedEventHandler : INotificationHandler<DomainEventNotification<GraduationCompletedEvent>>
    {
        ...
        public async Task Handle(DomainEventNotification<GraduationCompletedEvent> notification, CancellationToken cancellationToken)
        {
