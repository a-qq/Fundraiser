...
{
    internal sealed class MemberRestoredEventHandler : INotificationHandler<DomainEventNotification<MemberRestoredEvent>>
    {
        ...
        public async Task Handle(DomainEventNotification<MemberRestoredEvent> notification, CancellationToken cancellationToken)
        {
