...
{
    internal sealed class TreasurerDivestedEventHandler : INotificationHandler<DomainEventNotification<TreasurerDivestedEvent>>
    {
        ...
        public async Task Handle(DomainEventNotification<TreasurerDivestedEvent> notification, CancellationToken cancellationToken)
        {
