...
namespace SchoolManagement.Application.Schools.ItegrationEventHandlers.IDP
{
    internal sealed class
        HeadmasterDivestedEventHandler : INotificationHandler<DomainEventNotification<HeadmasterDivestedEvent>>
    {
        ...
        public async Task Handle(DomainEventNotification<HeadmasterDivestedEvent> notification,
