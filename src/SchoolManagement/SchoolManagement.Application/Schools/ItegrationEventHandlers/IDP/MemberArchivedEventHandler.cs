...
{
    internal sealed class MemberArchivedEventHandler : INotificationHandler<DomainEventNotification<MemberArchivedEvent>>
    {
        ...
        public async Task Handle(DomainEventNotification<MemberArchivedEvent> notification, CancellationToken cancellationToken)
        {
