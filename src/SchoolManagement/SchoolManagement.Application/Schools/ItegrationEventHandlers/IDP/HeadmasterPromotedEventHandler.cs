...
{
    internal sealed class HeadmasterPromotedEventHandler : INotificationHandler<DomainEventNotification<HeadmasterPromotedEvent>>
    {
        ...
        public async Task Handle(DomainEventNotification<HeadmasterPromotedEvent> notification, CancellationToken cancellationToken)
        {
